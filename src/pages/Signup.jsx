...
import { ChevronRight, User, Mail, Lock, Eye, EyeOff, CheckCircle } from "lucide-react";
...
const SignUp = () => {
  ...
  return (
    <div className=" flex items-center justify-center bg-gray-950 bg-[radial-gradient(circle_at_center,rgba(42,185,113,0.25)_0,rgba(0,0,0,0)_70%)] pt-16 pb-16">
        ...
        <div className="relative backdrop-blur-3xl bg-black/50 border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
          ...
          <div className="p-12">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-extrabold bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-600 bg-clip-text text-transparent">Create Your Account</h2>
              <p className="text-gray-300 mt-3 text-base font-medium">Join our innovative community today</p>
            </div>
                    ...
                    <div className="w-full h-2 bg-gray-900 rounded-full overflow-hidden">
                      <div 
                        className={`h-full transition-all duration-300 ${
                          passwordStrength === 0 ? 'w-1/4 bg-red-700' : 
                          passwordStrength === 1 ? 'w-2/4 bg-orange-700' : 
                          passwordStrength === 2 ? 'w-3/4 bg-yellow-700' : 
                          'w-full bg-emerald-700'
                        } rounded-full shadow-[0_0_8px_rgba(16,185,129,0.5)]`}
                      ></div>
                    </div>
              ...
              <div className="flex items-center">
                <div className="relative flex items-center">
                  ...
                  <div className="h-6 w-6 border border-gray-700 rounded-md flex items-center justify-center mr-3 bg-black/60 peer-checked:bg-emerald-700 peer-checked:border-emerald-700 transition-all duration-300 shadow-sm">
                    <CheckCircle className={`h-5 w-5 text-white ${formData.terms ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`} />
                  </div>
                </div>
                <label htmlFor="terms" className="text-sm text-gray-300 font-medium leading-tight">
                  I agree to the{" "}
                  <a href="#" className="text-emerald-500 hover:text-emerald-400 underline-offset-4 hover:underline transition-all duration-300">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-emerald-500 hover:text-emerald-400 underline-offset-4 hover:underline transition-all duration-300">
            ...
            <div className="mt-10 text-center">
              ...
              <p className="text-gray-300 text-sm font-semibold">
                ...
                <a href="/signin" className="text-emerald-500 hover:text-emerald-400 font-semibold hover:underline underline-offset-4 transition-all duration-300">
                  Sign in
                </a>
              </p>
            </div>
